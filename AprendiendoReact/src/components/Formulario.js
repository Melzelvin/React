...
class Formulario extends Component {
    ...
    state = { //Creo el State del componente
        user: {}       
    };

    recibirFormulario = (e) => {
        e.preventDefault();//Me permite solo actulizar la logica que tengo dentro del metodo y no actualizar todoa la pantalla
